            ...
            <div id='contact' className='flex flex-col md:flex-row justify-center items-center gap-14 h-fit w-full py-7 mt-7  relative'>
                <div className='flex flex-col items-start  justify-around w-[70vw] md:w-1/3 gap-10  md:gap-28'>
                    ...
                    <div className='flex flex-col gap-6 items-start '>
                        <a href='tel:+917879184133' className='hover:text-gray-800 active:text-red-600 duration-75'><i class="fa-solid fa-phone"></i> +91 7879184133</a>
                        <a href='mailto:harshcode07@gmail.com' className='hover:text-gray-800 active:text-red-600 duration-75'><i class="fa-solid fa-envelope"></i> harshcode07@gmail.com</a>
